...
import com.example.axway.mbsandroid.R;
...
import arrowmbs.apis.DefaultAPI;
...
public class UsersQuery extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		new Thread(new Runnable() {
			...
			public void run() {
				try {
					successResponse = new DefaultAPI(SdkClient.getInstance()).usersQuery(null,null,null,null,null,null ,null,null, null, null, null);
