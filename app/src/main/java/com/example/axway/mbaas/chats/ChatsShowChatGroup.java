...
public class ChatsShowChatGroup extends Activity {
                 ...
                 adapter.setOnDeleteClickListener(new ChatsRowAdapter.ChatsOnDeleteClickListener() {
                     ...
                     public void onClick(final int position, View v) {
                         ...
                         new Thread(new Runnable() {
                             ...
                             public void run() {
                                 try {
                                     JSONObject Res = new DefaultAPI(SdkClient.getInstance()).chatsDelete(chatId, null, null);
                ...
                if ((event.getAction() == KeyEvent.ACTION_DOWN)
                    ...
                    if (message.length() > 0) {
                        ...
                        new Thread(new Runnable() {
                            ...
                            public void run() {
                                try {
                                    responseHandler = new DefaultAPI(SdkClient.getInstance()).chatsCreate(participateIds,chatGroupId,message,null,null,null,null,null,null,null,null);
    ...
    private void ping() {
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                  responseHandler =  new DefaultAPI(SdkClient.getInstance()).chatsQuery(participateIds,chatGroupId,null,null,null,null,null,queryWhere,null,null,null,3);
