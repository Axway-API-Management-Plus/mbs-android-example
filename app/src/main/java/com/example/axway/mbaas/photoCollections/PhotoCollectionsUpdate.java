...
public class PhotoCollectionsUpdate extends Activity {
    ...
    private class apiTask extends AsyncTask<Void, Void, JSONObject> {
        ...
        protected JSONObject doInBackground(Void... voids) {
            try {
                successResponse = new DefaultAPI(SdkClient.getInstance()).photoCollectionsUpdate(data.get("collection_id").toString(),data.get("name").toString(), null,null,null,null,null,null);
    ...
    private class callApiTask extends AsyncTask<Void, Void, JSONObject> {
        ...
        protected JSONObject doInBackground(Void... voids) {
            try {
                successResponse = new DefaultAPI(SdkClient.getInstance()).photoCollectionsShow(data.get("collection_id").toString(),3,null);
            } catch (SdkException e) {
                exceptionThrown =e;
            }
            return successResponse;
