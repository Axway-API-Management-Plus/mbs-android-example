...
public class PlacesUpdate extends Activity {
    ...
    private class showPlaces extends AsyncTask<Void, Void, JSONObject> {
        ...
        protected JSONObject doInBackground(Void... voids) {
            ...
            try {
                successResponse = new DefaultAPI(SdkClient.getInstance()).placesShow(placeId, null, null, null);
    ...
    private class updatePlaces extends AsyncTask<Void, Void, JSONObject> {
        ...
        protected JSONObject doInBackground(Void... voids) {
            ...
            try {
                successResponse = new DefaultAPI(SdkClient.getInstance()).placesUpdate(data.get("place_id").toString(),
