...
public class AccessControlListsShow extends Activity {
    ...
    private class showACLTask extends AsyncTask<Void, Void, JSONObject>{
        ...
        protected JSONObject doInBackground(Void... voids){
            ...
            try {
                successResponse = new DefaultAPI(SdkClient.getInstance()).aCLsShow(null,data.get("name").toString(),null);
    ...
    private class updateACLTask extends AsyncTask<Void, Void, JSONObject> {
        ...
        protected JSONObject doInBackground(Void... voids) {
            ...
            try {
                successResponse = new DefaultAPI(SdkClient.getInstance()).aCLsUpdate(null, data.get("name").toString(), null,
    ...
    private class removeACLTask extends AsyncTask<Void, Void, JSONObject> {
        ...
        protected JSONObject doInBackground(Void... voids) {
            ...
            try {
                successResponse = new DefaultAPI(SdkClient.getInstance()).aCLsDelete(null, data.get("name").toString(), null, null);
            } catch (SdkException e) {
                exceptionThrown = e;
