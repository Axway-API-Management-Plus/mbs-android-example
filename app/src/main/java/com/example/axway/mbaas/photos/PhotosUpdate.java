...
public class PhotosUpdate extends Activity {
    ...
    private class callApiTask extends AsyncTask<Void, Void, JSONObject> {
        ...
        protected JSONObject doInBackground(Void... voids) {
            try {
                successResponse = new DefaultAPI(SdkClient.getInstance()).photosShow(data.get("photo_id").toString(),null,null,null);
    ...
    private class apiTask extends AsyncTask<Void, Void, JSONObject> {
        ...
        protected JSONObject doInBackground(Void... voids) {
            try {
                successResponse = new DefaultAPI(SdkClient.getInstance()).photosUpdate(data.get("photo_id").toString(),(File) data.get("photo")
