...
public class CustomObjectsUpdate extends Activity {
	...
	private class updateCustomObject extends AsyncTask<Void, Void, JSONObject> {
		...
		protected JSONObject doInBackground(Void... voids) {
			...
			try {
				successResponse = new DefaultAPI(SdkClient.getInstance()).customObjectsUpdate(data.get("classname").toString(),data.get("id").toString(),
	...
	private class showCustomObject extends AsyncTask<Void, Void, JSONObject> {
		...
		protected JSONObject doInBackground(Void... voids) {
			...
			try {
				successResponse = new DefaultAPI(SdkClient.getInstance()).customObjectsShow(
