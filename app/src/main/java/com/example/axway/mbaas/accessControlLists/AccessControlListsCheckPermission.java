...
public class AccessControlListsCheckPermission extends Activity {
    ...
    private class aclUsersTask extends AsyncTask<Void,Void, JSONObject> {
        ...
        protected JSONObject doInBackground(Void... voids) {
            try {
                successResponse = new DefaultAPI(SdkClient.getInstance()).usersQuery(null,null,null,null,null,null,null,null,null,3,null);
    ...
    private class checkPermission extends AsyncTask<Void, Void, JSONObject> {
        ...
        protected JSONObject doInBackground(Void... voids){
            ...
            try {
                successResponse = new DefaultAPI(SdkClient.getInstance()).aCLsCheck(data.get("name").toString(),null,null,
