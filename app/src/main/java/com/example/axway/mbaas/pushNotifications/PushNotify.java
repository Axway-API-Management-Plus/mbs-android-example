...
public class PushNotify extends Activity {
    ...
    private class notifyPush extends AsyncTask<Void, Void, JSONObject> {
        ...
        protected JSONObject doInBackground(Void... voids) {
            ...
            try {
                JSONObject usersResponse  = new DefaultAPI(SdkClient.getInstance()).usersQuery(null, null, null, null, null, null, null, null, null, null, null);
            ...
            try {
                successResponse = new DefaultAPI(SdkClient.getInstance()).pushNotificationsNotify(data.get("channel").toString(),null,
