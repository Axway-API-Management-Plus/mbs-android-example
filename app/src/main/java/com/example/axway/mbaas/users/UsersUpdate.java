...
public class UsersUpdate extends Activity {
    ...
    private class callapi extends AsyncTask<Void, Void, JSONObject> {
        ...
        protected JSONObject doInBackground(Void... voids) {
            try {
                successResponse = new DefaultAPI(SdkClient.getInstance()).usersShowMe(null, null);
    ...
    private class apiTask extends AsyncTask<Void, Void, JSONObject> {
        ...
        protected JSONObject doInBackground(Void... voids) {
            try {
                successResponse = new DefaultAPI(SdkClient.getInstance()).usersUpdate(data.get("email").toString(), data.get("username").toString(), data.get("password").toString(), data.get("password_confirmation").toString(),
