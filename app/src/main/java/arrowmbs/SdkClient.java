...
import arrowmbs.auth.SdkAPIKeyAuth;
import arrowmbs.auth.SdkAuthentication;
import arrowmbs.auth.SdkConstants;
import arrowmbs.auth.SdkHttpBasicAuth;
...
public class SdkClient implements SdkConstants {
   ...
   */
  private HttpContent serialize(Object obj, String contentType, Map<String, Object> formParams) throws SdkException {
    if (contentType.startsWith("multipart/form-data")) {
      throw new SdkException(SdkException.MULTIPART_NOT_SUPPORTED, "SDK SdkClient doesn't yet support multipart/form-data calls");
